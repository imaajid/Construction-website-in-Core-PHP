                ...
                <div class="banner_text">
                    <div class="banner_text_iner">
                        <h1>Committed
                            ...
                            and Results</h1>
                        <p>Moving male there under air air beast lesser creeping saying wherein two void can' ness saw
                            set meat our. Whose give day. Morning own fifth from Were moved darkness. Female bring
                            abundantly and research </p>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="about_part_text">
                    ...
                    <p>Which cattle fruitful he fly visi won't let above lesser stars. Fly form wonder every let third
                        form two air seas after us said day won light also together midst two female she great to
                        open.</p>
                    <ul>
                        <li>
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="single_feature">
                            <div class="single_service">
                                <span><?php echo "<img src='admin/upload/" . $row["image"] . "' width='60'> "; ?></span>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="about_part_text">
                    ...
                    <p>Their whose made waters there our, air above first give dry fruit that second whose herb creeping
                        ...
                        ourends herb upon which open lights had blessed replenish Cattle give his. Abundantly over
                        saying which beast dominion multiply behold to wateo.</p>
                        ...
                        <div class="col-lg-4 col-sm-6 all buildings">
                            <div class="single_our_project">
                                ...
                                <div class="single_offer">
                                    ...
                                    <img src="admin/upload/<?= $row['image'] ?> " alt="offer_img_1">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="single-footer-widget footer_1">
                    ...
                    <p>So seed seed green that winged cattle in Gahesd thing made fly you're no divided deep move lan
                        Gathering thing us land years living on floor me the cavaty do buty fresh</p>
                </div>
            </div>
