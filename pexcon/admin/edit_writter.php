...
$id = $_GET['id'];
$records = mysqli_query($conn,"SELECT * FROM writter where id = '$id'");
...
if(isset($_POST['submit']))
{
    ...
    if(isset($_FILES["image"]))
    {
        ...
        $edit = mysqli_query($conn," UPDATE writter set id ='$id', name ='$name',detail='$detail',image='$fileName' where id='$id'");


    }
    else{

        $edit = mysqli_query($conn," UPDATE writter set id ='$id', name ='$name',detail='$detail' where id='$id'");
    }
    ...
    if($edit)
    {
        ...
        header("location:list_writer.php"); // redirects to all records page
        exit;
    }
    else
    {
