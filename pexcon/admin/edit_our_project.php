...
if(isset($_POST['submit']))
{
    ...
    if(isset($_FILES["image"]))
    {
        ...
        $edit = mysqli_query($conn," UPDATE our_project set id ='$id', name ='$name', designation='$designation',image='$fileName' where id='$id'");


    }
    else{

        $edit = mysqli_query($conn," UPDATE our_project set id ='$id', name ='$name', designation='$designation' where id='$id'");
    }
