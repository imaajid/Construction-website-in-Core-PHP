...
$id = $_GET['id'];
$records = mysqli_query($conn,"SELECT * FROM feedback where id = '$id'");
...
if(isset($_POST['submit']))
{
    ...
    if(isset($_FILES["image"]))
    {
        ...
        $edit = mysqli_query($conn," UPDATE feedback set id ='$id', name ='$name',message='$message',image='$fileName' where id='$id'");


    }
    else{

        $edit = mysqli_query($conn," UPDATE feedback set id ='$id', name ='$name',message='$message' where id='$id'");
    }
